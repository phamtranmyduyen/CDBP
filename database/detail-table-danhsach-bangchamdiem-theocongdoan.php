...
while ($row = mysqli_fetch_array($result)) {
    ...
    //         <th class='tongdiemtieuchibch'><input class='textBCH$mabangdiem' type='number' min='0' name='txtTextBCH' id='txtTextBCH'/></th>
    //     </tr>";
    // }
    // else
    // {
    ...
    while ($row1 = mysqli_fetch_array($result1)) {
        ...
        while ($rowDiem = mysqli_fetch_array($queryDiem)) {
            if ($trangthai['Trạng thái'] == 'Chưa xử lý') {
                ...
                <th class='diemcdbpcham'><input class='textBCH$mabangdiem' type='number' min='0' name='txtTextBCH' id='txtTextBCH'/></th>                
            </tr>";
                ...
                <th class='diemchuanchitiettieuchi' value='" . $row1['Nội dung chi tiết tiêu chí'] . "'><pre class='txtdiemchuanchitiettieuchi'>" . $row1['Điểm chuẩn chi tiết tiêu chí'] . "</pre></th>
                <th class='diemcdbpcham'><pre class='textCDBP' id='txtTextCDBP'>" . $rowDiem['Điểm CDBP chấm'] . "</pre></th>
                <th class='diemcdbpcham'><input value='" . $rowDiem['Điểm BCH chấm'] . "' class='textBCH$mabangdiem' type='number' min='0' name='txtTextBCH' id='txtTextBCH'/></th>                
            </tr>";
            }
        }
    }
